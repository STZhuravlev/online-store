...
from .views import SignUp,  LogoutUser, UserResetPassword, UserResetPasswordDone,\
    UserResetPasswordConfirm, UserResetPasswordComplete, UserLogin, UserPasswordChange, UserPasswordChangeDone
...
urlpatterns = [
    ...
    path('password-reset', UserResetPassword.as_view(), name='password_reset'),
    path('password-reset/done', UserResetPasswordDone.as_view(), name='password_reset_done'),
